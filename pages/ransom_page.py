...
class RansomPage(BasePage):
    ...
    def checking_font_color_text_number_step(self, locator, property_elm, rsl):
        property_element = self.get_after(locator[1], property_elm)
        assert property_element == rsl
    ...
    def checking_font_size_text_number_step(self, locator, property_elm, rsl):
        property_element = self.get_after(locator[1], property_elm)
        assert property_element == rsl
    ...
    def checking_font_text_number_step(self, locator, property_elm, rsl):
        property_element = self.get_after(locator[1], property_elm)[1:9]
        assert property_element == rsl
    ...
    def checking_name_number_step(self, locator, property_elm, rsl):
        property_element = self.get_after(locator[1], property_elm).strip('"')
        assert property_element == rsl
